...
function toggleLocale() {
    const next: Locale = locale.value === 'en' ? 'vi' : 'en';
    setLocale(next);
}
</script>

<template>
    <div class="w-full dark:bg-slate-800/90 dark:text-white sticky top-0 shadow-md flex justify-between items-center z-999">
        <div>
